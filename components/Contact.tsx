...
const FormInputs=()=>{
	...
	return (
		<>
			...
			<button  
				type='submit' 
				className=' self-end bg-gray-900 text-white rounded-full py-3 px-7 flex-center gap-2 outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-95 transition group overflow-clip disabled:bg-opacity-70'
				disabled={pending}
			>
